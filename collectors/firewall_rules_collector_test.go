...
func firewallRulesExpectedMetrics() string {
	...
	# HELP wanguard_firewall_rules_count Count of active firewall rules
	# TYPE wanguard_firewall_rules_count gauge
	wanguard_firewall_rules_count 1
`
}
